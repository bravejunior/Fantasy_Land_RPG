...
namespace FantasyLandWebApi.Migrations
{
    ...
    [Migration("20230607122445_attributedata")]
    partial class attributedata
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Models.Entities._Ability.Attribute", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Description = "Insight represents a character's ability to delve into complex subjects and gain deep understanding through critical thinking, and analytical skills.",
                            Name = "Insight"
                        },
                        new
                        {
                            Id = 2,
                            Description = "Resilience represents a character's unwavering determination and unyielding spirit in the face of the realm's grim fate.",
                            Name = "Resilience"
                        },
                        new
                        {
                            Id = 3,
                            Description = "Intrigue represents a character's adeptness at navigating the complex political landscape of Distrea.",
                            Name = "Intrigue"
                        },
                        new
                        {
                            Id = 4,
                            Description = "Intuition represents a character's instinct, gut feeling, and the ability to read between the lines.",
                            Name = "Intuition"
                        },
                        new
                        {
                            Id = 5,
                            Description = "Presence represents a character's personal magnetism, natural charisma, and ability to inspire and influence others through their words and actions.",
                            Name = "Presence"
                        },
                        new
                        {
                            Id = 6,
                            Description = "Observation represents a character's keen attention to detail, heightened awareness, and ability to perceive subtle clues and patterns in their surroundings.",
                            Name = "Observation"
                        });
                });
