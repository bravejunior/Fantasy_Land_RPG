        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Portrait = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    RequirementValue = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CurrentPerseverance = table.Column<int>(type: "int", nullable: false),
                    MaxPerseverance = table.Column<int>(type: "int", nullable: false),
                    Portrait = table.Column<byte[]>(type: "varbinary(max)", nullable: false),
                    FactionId = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProfessionProgressions", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Equipments_Characters_PlayerCharacterId",
                        column: x => x.PlayerCharacterId,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Equipments_EquipmentSlots_EquipmentSlotId",
            ...
            migrationBuilder.CreateTable(
                name: "PlayerCharacterAttributes",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerCharacterAttributes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerCharacterAttributes_Attributes_AttributeId",
                        column: x => x.AttributeId,
                        principalTable: "Attributes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerCharacterAttributes_Characters_PlayerCharacterID",
                        column: x => x.PlayerCharacterID,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                name: "PlayerCharacterCapabilities",
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerCharacterCapabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerCharacterCapabilities_Capabilities_CapabilityID",
                        column: x => x.CapabilityID,
                        principalTable: "Capabilities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerCharacterCapabilities_Characters_PlayerCharacterID",
                        column: x => x.PlayerCharacterID,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlayerCharacterSkills", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PlayerCharacterSkills_Characters_PlayerCharacterID",
                        column: x => x.PlayerCharacterID,
                        principalTable: "Characters",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PlayerCharacterSkills_Skills_SkillId",
                        column: x => x.SkillId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipments_EquipmentSlotId",
                table: "Equipments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Equipments_PlayerCharacterId",
                table: "Equipments",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ItemRequirements_ItemId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PlayerCharacterAttributes_AttributeId",
                table: "PlayerCharacterAttributes",
                column: "AttributeId");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerCharacterAttributes_PlayerCharacterID",
                table: "PlayerCharacterAttributes",
                column: "PlayerCharacterID");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerCharacterCapabilities_CapabilityID",
                table: "PlayerCharacterCapabilities",
                column: "CapabilityID");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerCharacterCapabilities_PlayerCharacterID",
                table: "PlayerCharacterCapabilities",
                column: "PlayerCharacterID");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerCharacterSkills_PlayerCharacterID",
                table: "PlayerCharacterSkills",
                column: "PlayerCharacterID");

            migrationBuilder.CreateIndex(
                name: "IX_PlayerCharacterSkills_SkillId",
                table: "PlayerCharacterSkills",
                column: "SkillId");

            migrationBuilder.CreateIndex(
                name: "IX_ProfessionProgressions_ProfessionId",
